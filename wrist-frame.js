...
export function buildWristFrame(points, physicalHand) {
  ...
  // Re-ortonormaliza para impedir deformaciones numéricas.
 ...
 * Conservamos la API para no tocar hand-tracking.js, pero la orientación base
...
export function wristFrameMetrics(frame) {
  ...
  // X es ahora el eje longitudinal del antebrazo en la convención AMURA.
